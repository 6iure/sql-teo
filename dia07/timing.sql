--* query para descobrir quantos dias os sellers estao sem vender considerando que o dia de hoje é 2018-07-01
...
with tb_marcacao_seller as (
    ...
    SELECT 
        t2.seller_id,
        max(order_approved_at) as dt_ultima_venda,
        '2018-07-01' as dt_atual,
        julianday('2018-07-01') - julianday(max(order_approved_at)) as dt_ult_venda,
